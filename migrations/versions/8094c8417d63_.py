...
Revision ID: 8094c8417d63
Revises: 
Create Date: 2020-03-20 10:25:13.550980
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['generaluser.user_id'], ),
    sa.PrimaryKeyConstraint('user_id')
    )
